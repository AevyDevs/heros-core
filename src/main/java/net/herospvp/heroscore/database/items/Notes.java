...
public class Notes {
    ...
    public String selectWhere(String field, Object value) {
        return this.selectWhere(field, field, value);
    }

    public String selectWhere(String selected, String field, Object value) {
        String string;
        ...
        return "SELECT " + selected + " FROM " + table + " WHERE " + field + " = " + string + ";";
    }
